...
/// @brief Processes the left button mouse clicked down event
/// @param event 
...
/// @brief Processes the left button mouse clicked up event
/// @param event 
...
/// @brief  Processes the right button mouse clicked down event
/// @param event 
...
/// @brief Processes the right button mouse clicked up event
/// @param event 
...
/// @brief Processes the mouse move
/// @param event 
...
/// @brief Processes the mouse wheel scrolling event.
/// @param event 
...
/// @brief Processes the entering in window mouse event
/// @param event 
...
/// @brief Processes the leaving window mouse event
/// @param event 
